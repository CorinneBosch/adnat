...
shifts = [
  {
    ...
    shift_start: Time.new(2021, 11, 26, 11, 15, 00),
    shift_end: Time.new(2021, 11, 26, 22, 20, 00).strftime('%H:%M'),
    break_length: 45,
    organisation_id: 1, 
  },
  {
  ...
  },
  {
    ...
    shift_start: Time.new(2021, 11, 27, 12, 05, 00),
    shift_end: Time.new(2021, 11, 27, 21, 45, 00).strftime('%H:%M'),
    break_length: 45,
    organisation_id: 2, 
  },
  {
